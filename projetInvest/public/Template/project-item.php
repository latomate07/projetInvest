...
?> 
 ...
 <div class="project">
                ...
                <?php  // elseif (empty($user->get_user_avatar($find->id))) : ?>
                    <a href="#" class="userLink"><img src="http://localhost:8888/media/avatar.png"  alt="photo de profil" width="50px" height="50px" class="userLogo"></a>
                <?php  // endif ?>                      
                ...
                <div class="investir">
                    <p><a class="reactionBtn" href="/single-project.php?id=<?= $post->id; ?>"><i class="fa fa-chart-pie" style="margin-right:5px"></i>Investir</a></p>
                </div>
                <div class="discuss">
