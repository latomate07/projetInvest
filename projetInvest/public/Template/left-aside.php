...
<aside class="aside-block">
                ...
                <div class="card calltoaction">
                    ...
                    <div class="calltoaction">
                        <a class="btn" href="http://localhost:8888/public/modules/authentification/inscription.php">S'inscrire</a>
                        <a class="noBtn" href="http://localhost:8888/public/modules/authentification/connexion.php">Se connecter</a>
                    </div>
                </div> 
                ...
                <div class="card calltoaction">
                    ...
                    <div class="calltoaction">
                        <!-- Si profil utilisateur rempli => afficher ce qui suit -->
                        <a class="btn" href="/public/post-project.php">Commencer</a>
                        <!-- SInon -->
                        <!-- <a class="btn" href="#">Remplir le profil</a> -->
                    </div>
                </div>
